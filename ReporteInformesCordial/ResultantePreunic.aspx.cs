...
{
    public partial class ResultantePreunic : System.Web.UI.Page
    {
        ...
        private void Resultante(string desde1, string hasta1)
        {
            ...
            var retorno_datos1 = cv.listaOrigenDatosPU(desde1, hasta1);
        ...
        protected void btnImgExcel1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var datos = cruzverde.listaOrigenDatosPU(inicio1, fin1);

            if (datos.Count > 0)
            {
                string filename = "ResultantePreunic_ " + System.DateTime.Now.ToShortDateString() + "_.xls";
