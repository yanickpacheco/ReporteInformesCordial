...
{
    public partial class SegmentadorPreunic : System.Web.UI.Page
    {
        ...
        private void Segmen(string desde, string hasta)
        {
            ...
            var retorno_datos = seg.ListaDatosPU(desde, hasta);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var datos = seg.ListaDatosPU(inicio, fin);

            if (datos.Count > 0)
            {
                string filename = "SegmentadorPreunic " + System.DateTime.Now.ToShortDateString() + "_.xls";
