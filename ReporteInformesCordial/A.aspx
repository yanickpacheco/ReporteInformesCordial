    ...
    <title></title>
        ...
        <script type="text/javascript">
            $(document).load(function () {
                $("#content").attr("src", "http://192.168.1.14/ReportServer/Pages/ReportViewer.aspx?%2F170%20-%20BIenvenida%20Cruz%20Verde%2FInforme%20Calidad&rc:showbackbutton=true");
            })
</script>
