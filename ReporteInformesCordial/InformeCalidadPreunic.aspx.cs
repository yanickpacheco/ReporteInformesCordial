...
{
    public partial class CalidadPreunic : System.Web.UI.Page
    {
        ...
        private void InformeCalidad(string desde, string hasta)
        {
            ...
            var retorno_datos = cruzverde.ListarOrigenPU(desde, hasta);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var datos = cruzverde.ListarOrigenPU(inicio, fin);

            if (datos.Count > 0)
            {
                string filename = "InformeCalidadPreunic " + System.DateTime.Now.ToShortDateString() + "_.xls";
