<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="SegmentadorBienvenida.aspx.cs" Inherits="ReporteInformesCordial.SegmentadorBienvenida" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2_Empresa" runat="server">
     <h4  style="color:white"> <span>BIENVENIDA</span>
       <br />
    <asp:Label ID="lblEmpresa" runat="server" Text=""></asp:Label></h4>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1_Cuerpo" runat="server">
