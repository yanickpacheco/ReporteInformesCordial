<%@ Page Title="" Language="C#" MasterPageFile="~/MaestraClon.Master" AutoEventWireup="true" CodeBehind="InformeCalidadClon.aspx.cs" Inherits="ReporteInformesCordial.InformeCalidadClon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2_Empresa1" runat="server">
    <h4  style="color:white"> <span>CLON</span>
       <br />
    <asp:Label ID="lblEmpresa" runat="server" Text=""></asp:Label></h4>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1_Cuerpo1" runat="server">
