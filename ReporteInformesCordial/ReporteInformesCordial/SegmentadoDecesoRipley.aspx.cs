...
{
    public partial class SegmentadoDecesoRipley : System.Web.UI.Page
    {
        ...
        private void Segmen(string desde, string hasta)
        {
            ...
            var retorno_datos = seg.ListaDatosRipley(desde, hasta);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var datos = seg.ListaDatosRipley(inicio, fin);

            if (datos.Count > 0)
            {
                string filename = "SegmentadorRipley " + System.DateTime.Now.ToShortDateString() + "_.xls";
