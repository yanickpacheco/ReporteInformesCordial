...
{
    public partial class InformeCalidadRipley : System.Web.UI.Page
    {
        ...
        private void InformeCalidad(string desde, string hasta)
        {
            ...
            var retorno_datos = cruzverde.ListarOrigenRipley(desde, hasta);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (datos.Count > 0)
            {
                string filename = "InformeCalidadRipley " + System.DateTime.Now.ToShortDateString() + "_.xls";
