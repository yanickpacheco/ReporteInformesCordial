...
{
    public class CruzVerdeClonCalidad
    {
		int id;
		string usuario;
		...
		//Metodo listar
		public List<CruzVerdeClonCalidad>ListarOrigen(string desde, string hasta)
		{
			List<CruzVerdeClonCalidad> datos = new List<CruzVerdeClonCalidad>();
			...
			try
			{
				...
				while (rdr.Read())
				{
					CruzVerdeClonCalidad i = new CruzVerdeClonCalidad();
		...
		//Para calidad Preunic ocuparemos la misma clase de Clon
		public List<CruzVerdeClonCalidad> ListarOrigenPU(string desde, string hasta)
		{
			List<CruzVerdeClonCalidad> datos = new List<CruzVerdeClonCalidad>();
		...
		public List<CruzVerdeClonCalidad> ListarOrigenOdonto(string desde, string hasta)
		{
			List<CruzVerdeClonCalidad> datos = new List<CruzVerdeClonCalidad>();
