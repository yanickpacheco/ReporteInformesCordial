...
{
    public class CruzVerde_ReportesResultante
    {
        int id;
        string rut;
        string dv;
        ...
        //Metodo listar
        public List<CruzVerde_ReportesResultante> listaOrigenDatos(string desde1, string hasta1)
        {
            List<CruzVerde_ReportesResultante> datos = new List<CruzVerde_ReportesResultante>();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    CruzVerde_ReportesResultante i = new CruzVerde_ReportesResultante();
