<%@ Page Title="" Language="C#" MasterPageFile="~/Plus.Master" AutoEventWireup="true" CodeBehind="InformeCalidadPlus.aspx.cs" Inherits="ReporteInformesCordial.InformeCalidadPlus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head4" runat="server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2_Empresa4" runat="server">
     <h4  style="color:white"> <span>PLUS</span>
       <br />
    <asp:Label ID="lblEmpresa" runat="server" Text=""></asp:Label></h4>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1_Cuerpo4" runat="server">
