...
{
    public partial class InformeCalidadOdonto : System.Web.UI.Page
    {
        ...
        private void InformeCalidad(string desde, string hasta)
        {
            ...
            var retorno_datos = cruzverde.ListarOrigenOdonto(desde, hasta);
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var datos = cruzverde.ListarOrigenOdonto(inicio, fin);

            if (datos.Count > 0)
            {
                string filename = "InformeCalidadOdonto " + System.DateTime.Now.ToShortDateString() + "_.xls";
